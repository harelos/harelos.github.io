const CACHE='ox-v4-20260823-2';
const SHELL=['./','./index.html','./style-1.css','./style-2.css','./style-3.css','./app-loader.js','./app-1.txt','./app-2.txt','./app-3.txt','./app-4.txt','./app-5.txt','./app-6.txt','./manifest.webmanifest','../icon.svg'];
